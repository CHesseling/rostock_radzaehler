...
#%%
# parse_dates: Diese Spalten enthalten Datumsangaben
...
# %%
# resample fasst die 15-Min Daten eines Tages
# zusammen als 1 Tag ('D')
df_pivot_datum.resample('M').sum()
...
# %%
# die unteresten 7 Zeilen der Tabelle filtern
...
#%%
# Wir verschmelzen die beiden Dataframes andhand der Spalten, die die Stationsid enthalten
